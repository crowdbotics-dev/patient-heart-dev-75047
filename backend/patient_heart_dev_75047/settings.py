"""
Django settings for patient_heart_dev_75047 project.
...
ROOT_URLCONF = 'patient_heart_dev_75047.urls'
...
WSGI_APPLICATION = 'patient_heart_dev_75047.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_heart_dev_75047 API",
    "DESCRIPTION": "API documentation for patient_heart_dev_75047 App",
    "VERSION": "v1",
}
